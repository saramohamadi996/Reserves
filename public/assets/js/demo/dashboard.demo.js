  ...
  var serverChartOptions = {
    ...
    series: [{
      ...
      data: [
    	...
    	name: 'میزان استفاده از پردازنده',
      data: [
      	randomNo(), randomNo(), randomNo(), randomNo(), randomNo(), randomNo(), randomNo(), randomNo(), randomNo(), randomNo(), randomNo(), randomNo(), randomNo(), randomNo(), randomNo(),
      	randomNo(), randomNo(), randomNo(), randomNo(), randomNo(), randomNo(), randomNo(), randomNo(), randomNo()
      ]
    ...
    xaxis: {
      categories: ['فرودین', 'اردیبهشت', 'خرداد', 'تیر', 'مرداد', 'شهریور', 'مهر', 'آبان', 'آذر', 'دی', 'بهمن', 'اسفند', 'فرودین', 'اردیبهشت', 'خرداد', 'تیر', 'مرداد', 'شهریور', 'مهر', 'آبان', 'آذر', 'دی', 'بهمن', 'اسفند'],
      labels: {
				show: false
			}
    },
...
var handleRenderMap = function() {
	...
	$('#world-map').vectorMap({
		...
		markers: [
			{latLng: [41.90, 12.45], name: 'شهر واتیکان'},
			{latLng: [43.73, 7.41], name: 'موناکو'},
			{latLng: [-0.52, 166.93], name: 'نئورو'},
			{latLng: [-8.51, 179.21], name: 'توالو'},
			{latLng: [43.93, 12.46], name: 'سان مارینو'},
			{latLng: [47.14, 9.52], name: 'لیختن اشتاین'},
			{latLng: [7.11, 171.06], name: 'جزایر مارشال'},
			{latLng: [17.3, -62.73], name: 'سنت کیتس و نوید'},
			{latLng: [3.2, 73.22], name: 'مالدیو'},
			{latLng: [35.88, 14.5], name: 'مالت'},
			{latLng: [12.05, -61.75], name: 'گرنادا'},
			{latLng: [13.16, -61.23], name: 'سنت وینسنت و گرنادین'},
			{latLng: [13.16, -59.55], name: 'باربادوس'},
			{latLng: [17.11, -61.85], name: 'آنتیگوا و باربودا'},
			{latLng: [-4.61, 55.45], name: 'سیشل'},
			{latLng: [7.35, 134.46], name: 'پالائو'},
			{latLng: [42.5, 1.51], name: 'آندورا'},
			{latLng: [14.01, -60.98], name: 'سنت لوسیا'},
			{latLng: [6.91, 158.18], name: 'ایالت های فدرال میکرونزی'},
			{latLng: [1.3, 103.8], name: 'سنگاپور'},
			{latLng: [1.46, 173.03], name: 'کیریباتی'},
			{latLng: [-21.13, -175.2], name: 'تونگا'},
			{latLng: [15.3, -61.38], name: 'دومینیکا'},
			{latLng: [-20.2, 57.5], name: 'موریتیوس'},
			{latLng: [26.02, 50.55], name: 'بحرین'},
			{latLng: [0.33, 6.73], name: 'سائو تومه اند پرنسس'}
		]
	});
}

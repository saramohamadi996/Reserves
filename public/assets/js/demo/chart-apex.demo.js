...
var handleRenderApexChart = function() {
	...
	var apexLineChartOptions = {
		...
		title: {
			text: 'میانگین دمای پایین و بالا',
			align: 'center',
			color: app.color.white
		},
	...
	var apexAreaChartOptions = {
		...
		xaxis: {
			type: 'datetime',
			categories: ['1400-09-19T00:00:00', '1400-09-19T01:30:00', '1400-09-19T02:30:00', '1400-09-19T03:30:00', '1400-09-19T04:30:00', '1400-09-19T05:30:00', '1400-09-19T06:30:00'],
			axisBorder: {
				show: true,
	...
	var apexBarChartOptions = {
		...
		xaxis: {
			categories: [1395, 1396, 1397, 1398, 1399, 1400, 1401],
			axisBorder: {
				show: true,
				color: app.color.gray300,
				height: 1,
	...
	var apexMixedChartOptions = {
		...
		xaxis: {
			categories: [1393, 1394, 1395, 1396, 1397, 1398, 1400, 1401, 1401],
			axisBorder: {
				show: true,
				color: app.color.gray300,
				height: 1,
	...
	var apexPieChartOptions = {
		...
		labels: ['تیم ا', 'تیم ب', 'تیم س', 'تیم د', 'تیم ی'],
	...
	var apexRadialBarChartOptions = {
		...
		series: [76, 67, 61, 90],
		labels: ['ویمو', 'مسنجر', 'فیسبوک', 'لینکدین'],
		legend: {
			show: true,
			floating: true,
			position: 'left',

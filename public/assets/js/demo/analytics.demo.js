  ...
  tooltips: {
    ...
    callbacks: {
      ...
      labelColor: function (tooltipItem, chart) {
        ...
        console.log(chart);
        return {
          borderColor: hexToRgba(COLOR_WHITE, 0.75),
...
var handleRenderChart = function () {
  ...
  chart1 = new Chart(ctx, {
    type: "line",
    data: {
      labels: ["", "4 صبح ", "8 صبح ", "12 عصر", "4 عصر", "8 عصر", newDate(1)],
      datasets: [
        {
  ...
  chart3 = new Chart(ctx3, {
    ...
    data: {
      ...
      datasets: [
        ...
        {
          color: app.color.theme,
          backgroundColor: hexToRgba(app.color.theme, 0.2),
          borderColor: app.color.theme,
          borderWidth: 2,
          pointBackgroundColor: app.color.gray900,
          pointBorderWidth: 2,

!function (e) {
        ...
        !function () {
            ...
            function d(r) {
                ...
                if (p.documentWriteIntervention = n(), p.firstPaint = t("first-paint"), p.firstContentfulPaint = t("first-contentful-paint"), p.errorCount = window.__cfErrCount || 0, g && (g.icTag && (p.icTag = g.icTag), p.siteToken = g.token, R = !0), "function" == typeof l.getEntriesByType) {
                    var h = l.getEntriesByType("resource"), w = 0, T = 0;
            ...
            if (!g || "single" !== g.load) {
                if (p) {
                    ...
                    if (y) try {
                        ...
                        if (h && "function" == typeof URLSearchParams) {
                            var w = new URLSearchParams(h.replace(/^[^\?]+\??/, "")), T = w.get("token");
                            T && (g.token = T);
                            var S = w.get("spa");
                            g.spa = null === S || "true" === S
                        }
                ...
                if (l && g && g.token) {
                    ...
                    var C = {lcp: void 0, cls: void 0, fid: void 0}, O = function (e) {
                        ...
                        j = function (e) {
                            var t = function (e, t) {
                                n.resources = e, 0 != t && (n.bypassTiming = !0), g && (1 === g.r && (n.resources = []), k && 0 === t && (m.push({
                                    id: n.pageloadId,
                                    url: n.location
                                }), m.length > 3 && m.shift()), (0, o.sendObjectBeacon)("", n, function () {
                                }, !1, A), void 0 !== g.forward && void 0 !== g.forward.url && (0, o.sendObjectBeacon)("", n, function () {
                                }, !1, g.forward.url))
                            }, n = d(e);
                            if (n && g) {
                            ...
                            var t = f();
                            e || (t.resources = [], delete t.tempResources), g && (0, o.sendObjectBeacon)("", t, function () {
                            }, !0, A)
                        }, I = function () {
                            R = !0;
    ...
    }, T = {passive: !0, capture: !0}, S = new Date, E = function (e, t) {
